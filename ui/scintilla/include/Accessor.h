...
public:
	Accessor() : startPos(extremePosition), endPos(0), codePage(0) { currentPos = -1; }// SuperCx
	virtual ~Accessor() {}
	...
	// SuperCx
	virtual void SafeSetCharAt(int position, const char ch) = 0;
	...
	virtual void PendModify() = 0; // SuperCx
	int currentPos; // SuperCx
};
