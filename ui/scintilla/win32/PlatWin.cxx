...
public:
	ListBoxX() : lineHeight(10), fontCopy(0), lb(0), unicodeMode(false),
		desiredVisibleRows(7), maxItemCharacters(0), aveCharWidth(8){
	}
	virtual ~ListBoxX() {
		if (fontCopy) {
	...
	virtual int SetTopIndex(int n); //SuperCx
...
int ListBoxX::SetTopIndex(int n)
{
	return ::SendMessage(lb, LB_SETTOPINDEX, n, 0);
}
