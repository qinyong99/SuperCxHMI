...
void DocumentAccessor::SafeSetCharAt(int position, const char ch)
{
	pdoc->BasicChangeChar(position, ch);
}
...
void DocumentAccessor::PendModify()
{
	pdoc->m_bPendModify = true; // SuperCx
}
