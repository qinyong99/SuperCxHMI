========================================================================
		ActiveX Control DLL : CXRUNCTRL
========================================================================

ControlWizard has created this project for your CXRUNCTRL ActiveX Control
...
that make up your CXRUNCTRL ActiveX Control DLL.
...
RunCtrl.h
	This file contains the declaration of the CRunCtrl C++ class.

RunCtrl.cpp
	This file contains the implementation of the CRunCtrl C++ class.

RunCtrlPpg.h
	This file contains the declaration of the CRunCtrlPropPage C++ class.

RunCtrlPpg.cpp
	This file contains the implementation of the CRunCtrlPropPage C++ class.

RunCtrl.bmp
	This file contains a bitmap that a container will use to represent the
	CRunCtrl control when it appears on a tool palette.  This bitmap
	is included by the main resource file CxRunCtrl.rc.
