...
// Attributes
public:
//	IActiveScriptPtr m_pSaveActiveScript;

	IActiveScriptPtr m_pActiveScript;
	IActiveScriptParsePtr m_pActiveScriptParse;

	BOOL m_bIgnorAllError;
	CScriptErrorDlg* m_pScriptErrorDlg;
...
public:
	...
	virtual void GetSourceContextText(DWORD dwCookie, CString& strText) {}

	virtual BOOL EnableModeless(BOOL bEnable);
