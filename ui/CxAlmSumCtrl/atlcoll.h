...
#pragma warning(disable: 4530)  // C++ Exception Specification ignored //改动，自己加入
...
public:
	...
	static int CompareElementsOrdered( INARGTYPE bstr1, INARGTYPE bstr2 ) throw()
	{
		if( bstr1.m_str == NULL )
		{
			return( (bstr2.m_str == NULL) ? 0 : -1 );
		}
		else if( bstr2.m_str == NULL )
		{
			return( 1 );
		}
...
private:
	...
	CNode* NewNode( KINARGTYPE key, VINARGTYPE value ) /*改动throw( ... )*/;
	void FreeNode(CNode* pNode) throw();
	...
	CNode* InsertImpl( KINARGTYPE key, VINARGTYPE value ) /*改动throw( ... )*/;
...
protected:
	...
	CNode* RBInsert( KINARGTYPE key, VINARGTYPE value ) /*改动throw( ... )*/;
...
template< typename K, typename V, class KTraits, class VTraits >
CRBTree< K, V, KTraits, VTraits >::CNode* CRBTree< K, V, KTraits, VTraits >::NewNode( KINARGTYPE key, VINARGTYPE value ) /*改动throw( ... )*/
{
	if( m_pFree == NULL )
	{
		if (m_pNil == NULL)
...
template< typename K, typename V, class KTraits, class VTraits >
CRBTree< K, V, KTraits, VTraits >::CNode* CRBTree< K, V, KTraits, VTraits >::InsertImpl( KINARGTYPE key, VINARGTYPE value ) /*改动throw( ... )*/
{
...
template< typename K, typename V, class KTraits, class VTraits >
CRBTree< K, V, KTraits, VTraits >::CNode* CRBTree< K, V, KTraits, VTraits >::RBInsert( KINARGTYPE key, VINARGTYPE value ) /*改动throw( ... )*/
{
...
public:
	...
	bool Lookup( KINARGTYPE key, VOUTARGTYPE value ) const /*改动throw( ... )*/;
	const CPair* Lookup( KINARGTYPE key ) const throw();
	CPair* Lookup( KINARGTYPE key ) throw();
	POSITION SetAt( KINARGTYPE key, VINARGTYPE value ) /*改动throw( ... )*/;
	bool RemoveKey( KINARGTYPE key ) throw();
};
...
template< typename K, typename V, class KTraits, class VTraits >
bool CRBMap< K, V, KTraits, VTraits >::Lookup( KINARGTYPE key, VOUTARGTYPE value ) const /*改动throw( ... )*/
{
...
template< typename K, typename V, class KTraits, class VTraits >
POSITION CRBMap< K, V, KTraits, VTraits >::SetAt( KINARGTYPE key, VINARGTYPE value ) /*改动throw( ... )*/
{
...
public:
	...
	POSITION Insert( KINARGTYPE key, VINARGTYPE value ) /*改动throw( ... )*/;
...
template< typename K, typename V, class KTraits, class VTraits >
POSITION CRBMultiMap< K, V, KTraits, VTraits >::Insert( KINARGTYPE key, VINARGTYPE value ) /*改动throw( ... )*/
{
	return( RBInsert( key, value ) );
}
